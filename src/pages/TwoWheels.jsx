...
function TwoWheels() {
  ...
  const filteredProducts = twoWheelsProducts.filter(product => 
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="relative max-w-md mx-auto">
            <input
              type="text"
              placeholder="Cari produk two wheels..."
              value={searchTerm}
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-12">
            <p className={`text-2xl mb-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-500'}`}>
